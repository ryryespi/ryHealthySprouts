...
<body>
            ...
            <div class="col-md-6">
                <div class="card d-flex align-items-stretch rounded-lg text-center text-light">
                    ...
                    <div class="card-body hs-font-cyan">
                        ...
                        <br>
                        <p class="card-text h5 text-uppercase d-none d-md-block">
                            <a class="hs-font-cyan" href="#info2">Microgreens Are full of Health Benefits</a><br>
                            <a class="hs-font-cyan" href="#info">Learn About Microgreens</a>
                        </p>
                        <p class="card-text h6 d-md-none">
                            <a class="hs-font-cyan link" href="#info2">Microgreens Are full of Health Benefits</a><br>
                            <a class="hs-font-cyan link" href="#info">Learn About Microgreens</a>
                        </p>
    ...
    <!-- Info 2 section -->
    <section id="info2" class="container px-auto">
        <div class="row flex-column w-100 mx-auto justify-content-center">
                        ...
                        <div class="col d-flex align-items-stretch">
                            <div class="card text-center" alt="...">
                                ...
                                <div id="collapseAmaranth" class="collapse card-body text-center">
                                    <p class="card-text">Facts: Mild, earthy taste. Use in pasta dishes,
                                        quinoa
                                        dishes,
                                        great pair
                                        with Salmon.
                        ...
                        <div class="col d-flex align-items-stretch">
                            <div class="card" alt="...">
                                ...
                                <div id="collapseArugula" class="collapse card-body text-center">
                                    <p class="card-text"> Fact: It's a pepper, distinctive tasting green that
                                        was
                                        originally know in
                        ...
                        <div class="col d-flex align-items-stretch">
                            <div class="card" alt="...">
                                ...
                                <div id="collapsePea" class="collapse card-body text-center">
                                    <p class="card-text"> Facts: Bright green, crisp texture and earthy aroma,
                                        they are like
                                        peas and are
        ...
        <div class="row justify-content-center hs-ref-text">
            ...
            <div class="col-5 text-left">
                ...
                <span>Photo by <a class="text-light"
                        ...
                        Winkler</a> on <a class="text-light"
